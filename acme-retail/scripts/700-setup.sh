...
COURSE_ROOT="${1:-/workspaces/Solace_Academy_SAM_Dev_Demo/700-System-Design}"
...
# ----------------------------
# EMAIL SERVICE SETUP (Module 700)
# ----------------------------
...
# ----------------------------
# Add Email Tool to IncidentResponseAgent (Module 700)
# ----------------------------
...
# ----------------------------
# Enable Scheduler Service in WebUI Gateway (Module 700)
# ----------------------------
...
# ----------------------------
# Generate Morning Briefing Workflow (Module 700)
# ----------------------------
